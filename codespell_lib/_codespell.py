...
TOML_FILE = {
    "bash": "_shtab_codespell_compgen_toml_files",
...
PREAMBLE = {
    "bash": """
# $1=COMP_WORDS[1]
_shtab_codespell_compgen_toml_files() {
...
def parse_options(args):
    ...
    parser.add_argument('-i', '--interactive',
                        ...
                        help='set interactive mode when writing changes:' + dict_to_help(interactive_opts) + '\n'  # noqa: E501
                             'As usual with bitmasks, these levels can be '
                             'combined; e.g. use 3 for levels 1+2, etc. '
    ...
    parser.add_argument('--toml', type=str,
                        help='path to a pyproject.toml type file.',
                        ).complete = TOML_FILE
