...
allowed_dups = {
    ...
    ("dictionary.txt", "dictionary_en_to_en-OX.txt"),
    ...
    ("dictionary_code.txt", "dictionary_en_to_en-OX.txt"),
    ("dictionary_rare.txt", "dictionary_en-GB_to_en-US.txt"),
    ("dictionary_rare.txt", "dictionary_en_to_en-OX.txt"),
...
def test_dictionary_looping(
    ...
    for other_fname, other_err_dict in global_err_dicts.items():
        ...
        for err in this_err_dict:
            assert err not in other_err_dict or this_err_dict[err] != other_err_dict[err], (
